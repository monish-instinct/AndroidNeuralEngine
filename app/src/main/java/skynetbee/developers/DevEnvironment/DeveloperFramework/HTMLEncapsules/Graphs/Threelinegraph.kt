...
fun ThreeLineGraph(
    ...
    val allValues = shareData1.second + shareData2.second + shareData3.second
    ...
    Column(
        ...
        Text(
            ...
            modifier = Modifier.padding(bottom = 10.dp)
                ...
                // X-axis Labels
                val maxDataPoints = maxOf(shareData1.second.size, shareData2.second.size, shareData3.second.size)
                ...
                listOf(shareData1, shareData2, shareData3).forEachIndexed { dataIndex, (_, values) ->
            ...
            listOf(shareData1, shareData2, shareData3).forEachIndexed { index, (name, _) ->
